...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container frmStyle" data-aos="fade-up">
        ...
        <div class="row mt-5 mb-5 justify-content-center" runat="server" id="NuevaMarca" visible="false">
            <form class="frmStyle">
                <div class="col-md-6">
        ...
        <div class="row justify-content-center" runat="server" visible="false" id="debaja">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="deleteType">Selecciona la Marca a volver a dar el alta</label>
