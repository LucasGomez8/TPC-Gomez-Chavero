            ...
            <form>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <asp:DropDownList cssClass="form-control" ID="dropCategorias" runat="server" OnSelectedIndexChanged="dropCategoria_SelectedIndexChanged" AutoPostBack="true" />
                    </div>
                </div>
                ...
                <label for="txtNCategoria">Nombre de Categoria</label>
                 <asp:TextBox ID="txtNCategoria" runat="server" Enabled="false" CssClass="form-control" onkeydown="return (event.keyCode != 13);" OnTextChanged="txtNCategoria_TextChanged" AutoPostBack="true" />
              </div>
              </div>
            </form>
